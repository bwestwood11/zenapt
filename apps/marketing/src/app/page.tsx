          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-6xl font-bold text-slate-900 leading-tight tracking-tight">
                Effortless Bookings for the World&apos;s Most <span className="text-violet-600">Exclusive Spas</span>
              </h1>

              <p className="text-xl text-slate-600 leading-relaxed max-w-lg">
                From appointment scheduling to client follow-ups — elevate your med spa experience with software
                designed for luxury service providers.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-500">Join 500+ luxury med spas already using our platform</p>
            </div>
            ...
            <div className="flex items-center gap-8 pt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-700">Smart Scheduling</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="h-5 w-5 text-violet-600" />
                <span className="text-sm font-medium text-slate-700">Client Management</span>
              </div>
              <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 bg-violet-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-slate-900">Botox Consultation</p>
                        <p className="text-sm text-slate-600">Sarah Johnson • 10:00 AM</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-slate-900">Facial Treatment</p>
                        <p className="text-sm text-slate-600">Emma Davis • 2:30 PM</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-600">Michael Chen • 4:00 PM</p>
                      </div>
                    </div>
                  </div>
                </div>
